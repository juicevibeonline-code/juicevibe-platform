            ...
            >
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {popularItems.map((item) => (
                  <div key={item.id} className="rounded-[2rem] border border-gray-200 bg-white/90 p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-md">
                    ...
                    <h3 className="mt-5 text-xl font-semibold text-dark-green">{item.name}</h3>
